javascript:var b64pad='';var DEBUG=false;var chrsz=8;var inputArray=new Array();var specialIterations=[{domains:['fh-wels.at','fh-ooe.at','fhooe.at'],iter:6,addOnes:true},{domains:['cardcomplete.com'],iter:1,addOnes:true},{domains:['google.com','google'],iter:2,addOnes:false},{domains:['ebay'],iter:1,addOnes:false},{domains:['evernote.com'],iter:1,addOnes:false}];function b64_sha1(s){return binb2b64(core_sha1(str2binb(s),s.length*chrsz));}
